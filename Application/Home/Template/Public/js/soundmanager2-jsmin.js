/**
 * Created by zhaojun on 2016/4/2.
 */
/** @license
...
(function (k, g) {
    function fa(fa, wa) {
        ...
        var Va, c = this, Wa = null, l = null, sb = "HTML5::", A, u = navigator.userAgent, U = k.location.href.toString(), p = document, xa, Xa, ya, m, G = [], za = !0, C, V = !1, W = !1, q = !1, t = !1, ha = !1, n, tb = 0, X, B, Aa, O, Ba, M, P, Q, Ya, Ca, Da, ia, I, ja, Ea, R, Fa, Y, ka, la, S, Za, Ga, $a = ["log", "info", "warn", "error"], ab, Ha, bb, Z = null, Ia = null, r, Ja, T, cb, ma, na, J, w, $ = !1, Ka = !1, db, eb, fb, oa = 0, aa = null, pa, N = [], ba, z = null, gb, qa, ca, K, ra, La, hb, x, ib = Array.prototype.slice, E = !1, Ma, F, Na, jb, H, kb, Oa, sa, lb = 0, ta = u.match(/(ipad|iphone|ipod)/i), mb = u.match(/android/i), L = u.match(/msie/i),
            ...
            rb = "mpeg4 aac flv mov mp4 m4v f4v m4a m4b mp4v 3gp 3g2".split(" "), vb = RegExp("\\.(" + rb.join("|") + ")(\\?.*)?$", "i");
        ...
        this.createSound = function (b, d) {
            ...
            if (qa(f))a = e(), c._wD(f.id + ": Using HTML5"), a._setup_html5(f); else {
        ...
        this.onready = function (b, d) {
            if ("function" === typeof b)q && c._wD(r("queue", "onready")), d || (d = k), Ba("onready", b, d), M(); else throw r("needFunction",
                "onready");
            return !0
        };
        this.ontimeout = function (b, d) {
            if ("function" === typeof b)q && c._wD(r("queue", "ontimeout")), d || (d = k), Ba("ontimeout", b, d), M({type: "ontimeout"}); else throw r("needFunction", "ontimeout");
            return !0
        };
        this._writeDebug = function (b, d) {
            ...
            if (da && c.useConsole) {
                if (d && "object" === typeof d)console.log(b, d); else if ($a[d] !== g)console[$a[d]](b); else console.log(b);
        ...
        this.reboot = function (b, d) {
            ...
            c.sounds = {};
            lb = 0;
            if (b)G = []; else for (e in G)if (G.hasOwnProperty(e)) {
                a = 0;
        ...
        Va = function (b) {
            var d, e, a = this, f, k, h, v, p, q, s = !1, D = [], u = 0, Ua, z, t = null, A;
            e = d = null;
            ...
            this.load = function (b) {
                ...
                if (qa(e))d = a._setup_html5(e), d._called_load ? c._wD(a.id + ": Ignoring request to load again") : (a._html5_canplay = !1, a.url !== e.url && (c._wD(n("manURL") + ": " + e.url), a._a.src =
                    e.url, a.setPosition(0)), a._a.autobuffer = "auto", a._a.preload = "auto", a._a._called_load = !0); else {
            ...
            this.start = this.play = function (b, d) {
                ...
                if (a.paused && 0 <= a.position && (!a._iO.serverURL || 0 < a.position))c._wD(e + "Resuming from paused state", 1), a.resume(); else {
                    ...
                    if (null !== a._iO.from && null !== a._iO.to && 0 === a.instanceCount && 0 === a.playState && !a._iO.serverURL) {
                        ...
                        if (a.isHTML5 && !a._html5_canplay)c._wD(e + "Beginning load for from/to case"), a.load({_oncanplay: f}), y = !1; else if (!a.isHTML5 && !a.loaded && (!a.readyState ||
                            2 !== a.readyState))c._wD(e + "Preloading for from/to case"), a.load({onload: f}), y = !1;
                        if (null !== y)return y;
                        a._iO = z()
                    }
            ...
            this.clearOnPosition = function (a, b) {
                ...
                a = parseInt(a, 10);
                if (isNaN(a))return !1;
                for (c = 0; c < D.length; c++)if (a === D[c].position && (!b || b === D[c].method))D[c].fired && u--, D.splice(c, 1)
            };
            ...
            this._setup_html5 = function (b) {
                b = B(a._iO, b);
                var c = E ? Wa : a._a, d = decodeURI(b.url), e;
                E ? d === decodeURI(Ma) && (e = !0) : d === decodeURI(t) &&
                (e = !0);
                if (c) {
                    if (c._s)if (E)c._s && (c._s.playState && !e) && c._s.stop(); else if (!E && d === decodeURI(t))return a._apply_loop(c, b.loops), c;
            ...
            this._onfailure = function (b, d, e) {
                ...
                if (a._iO.onfailure && 1 === a.failures)a._iO.onfailure(a, b, d, e); else c._wD(a.id + ": Ignoring failure")
            };
        ...
        Aa = function (b, d) {
            var e, a = !0, f = d !== g, y = c.setupOptions;
            if (b === g) {
                a = [];
        ...
        x = function () {
            ...
            function c(b, d) {
                var g = b.shift(), v = [a[d]];
                if (e)g[v](b[0], b[1]); else g[v].apply(g, b)
            }

            var e = k.attachEvent, a = {
        ...
        H = {
            ...
            playing: s(function () {
                ...
                var d = this._s, e, a, f;
                e = 0;
                var g = "progress" === b.type, h = b.target.buffered, v = b.loaded || 0, k = b.total || 1;
                d.buffered = [];
                if (h && h.length) {
                    e = 0;
                    for (a = h.length; e < a; e++)d.buffered.push({start: 1E3 * h.start(e), end: 1E3 * h.end(e)});
        ...
        qa = function (b) {
            return !b || !b.type && !b.url && !b.serverURL ? !1 : b.serverURL || b.type && ga(b.type) ? !1 : b.type ? ca({type: b.type}) : ca({url: b.url}) || c.html5Only || b.url.match(/data\:/i)
        };
        ra = function (b) {
            var d;
        ...
        ca = function (b) {
            ...
            a && c.html5[a] !== g ? d = c.html5[a] && !ga(a) : (b = "audio/" + a, d = c.html5.canPlayType({type: b}),
        ...
        hb = function () {
            function b(a) {
                ...
                if (a instanceof Array) {
                    h = 0;
                    for (b = a.length; h < b; h++)if (c.html5[a[h]] || d.canPlayType(a[h]).match(c.html5Test))e = !0, c.html5[a[h]] = !0, c.flash[a[h]] = !!a[h].match(ob);
                    b = e
            ...
            var d = Audio !== g ? Pa && 10 > opera.version() ?
                new Audio(null) : new Audio : null, e, a, f = {}, k, h;
            k = c.audioFormats;
            for (e in k)if (k.hasOwnProperty(e) && (a = "audio/" + e, f[e] = b(k[e].type), f[a] = f[e], e.match(ob) ? (c.flash[e] = !0, c.flash[a] = !0) : (c.flash[e] = !1, c.flash[a] = !1), k[e] && k[e].related))for (h = k[e].related.length - 1; 0 <= h; h--)f["audio/" + k[e].related[h]] = f[e], c.html5[k[e].related[h]] = f[e], c.flash[k[e].related[h]] = f[e];
        ...
        M = function (b) {
            ...
            var d = {success: b && b.ignoreInit ? c.ok() : !t}, e = b && b.type ? G[b.type] || [] : [], a = [], f, d = [d], g = z && !c.ok();
        ...
        Na = function () {
            if (F !== g)return F;
            var b = !1, c = navigator, e = c.plugins, a, f = k.ActiveXObject;
            ...
            (b = !0); else if (f !== g && !u.match(/MSAppHost/i)) {
                try {
        ...
        gb = function () {
            ...
            if (ta && u.match(/os (1|2|3_0|3_1)/i))c.hasHTML5 = !1, c.html5Only = !0, c.oMC && (c.oMC.style.display = "none"); else if (c.useHTML5Audio) {
            ...
            if (c.useHTML5Audio && c.hasHTML5)for (d in ba = !0, e)if (e.hasOwnProperty(d) && e[d].required)if (c.html5.canPlayType(e[d].type)) {
        ...
        la = function (b, d) {
            ...
            var f = d || c.url, k = c.altURL || f,
                h = ka(), l = T(), m = null, m = p.getElementsByTagName("html")[0], n, s, q, m = m && m.dir && m.dir.match(/rtl/i);
            b = b === g ? c.id : b;
            Da();
            c.url = bb(ea ? f : k);
            d = c.url;
            ...
            if (L)f = p.createElement("div"), s = ['\x3cobject id\x3d"' + b + '" data\x3d"' + d + '" type\x3d"' + h.type + '" title\x3d"' + h.title + '" classid\x3d"clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase\x3d"' + pb + 'download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version\x3d6,0,40,0"\x3e', a("movie", d), a("AllowScriptAccess", c.allowScriptAccess), a("quality", h.quality), c.wmode ?
                a("wmode", c.wmode) : "", a("bgcolor", c.bgColor), a("hasPriority", "true"), c.debugFlash ? a("FlashVars", h.FlashVars) : "", "\x3c/object\x3e"].join(""); else for (n in f = p.createElement("embed"), h)h.hasOwnProperty(n) && f.setAttribute(n, h[n]);
            Ga();
            l = T();
            if (h = ka())if (c.oMC = A(c.movieID) || p.createElement("div"), c.oMC.id)q = c.oMC.className, c.oMC.className = (q ? q + " " : "movieContainer") + (l ? " " + l : ""), c.oMC.appendChild(f), L && (n = c.oMC.appendChild(p.createElement("div")), n.className = "sm2-object-box", n.innerHTML = s), W = !0; else {
                c.oMC.id =
                    c.movieID;
        ...
        R = function () {
            ...
            -1 !== d.indexOf("sm2-usehtml5audio\x3d") && (b = "1" === d.charAt(d.indexOf("sm2-usehtml5audio\x3d") +
                    18), da && console.log((b ? "Enabling " : "Disabling ") + "useHTML5Audio via URL parameter"), c.setup({useHTML5Audio: b}));
