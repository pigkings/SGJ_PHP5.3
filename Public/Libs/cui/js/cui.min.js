+function (t) {
    ...
    i.VERSION = "3.3.5", i.TRANSITION_DURATION = 150, i.DEFAULTS = {
        ...
        var c = /top|bottom/.test(i), p = c ? 2 * d.left - n + l : 2 * d.top - s + h, f = c ? "offsetWidth" : "offsetHeight";
    ...
    t(document).delegate(".ajax-get", "click", function () {
        ...
        return t(this).hasClass("confirm") && !confirm("确认要执行该操作吗?") ? !1 : (((e = t(this).attr("href")) || (e = t(this).attr("url"))) && (t(this).addClass("disabled").attr("autocomplete", "off").prop("disabled", !0), t.get(e).success(function (e) {
            if (1 == e.status) {
                if (e.url && !t(i).hasClass("no-refresh"))var o = e.info + " 页面即将自动跳转~"; else var o = e.info;
    ...
    t(document).delegate(".ajax-post", "click", function () {
        var e, i, o, n = t(this).attr("target-form"), s = this, a = !1;
        if ("submit" == t(this).attr("type") || (e = t(this).attr("href")) || (e = t(this).attr("url"))) {
            if (o = t("." + n), "true" === t(this).attr("hide-data"))o = t(".hide-data"), i = o.serialize(); else {
            ...
            t(s).addClass("disabled").attr("autocomplete", "off").prop("disabled", !0), t.post(e, i).success(function (e) {
                if (1 == e.status) {
                    if (e.url && !t(s).hasClass("no-refresh"))var i = e.info + " 页面即将自动跳转~"; else var i = e.info;
    ...
    function e(e) {
        return this.each(function () {
            var o = t(this), n = o.data("bs.image-grid"), s = t.extend({}, i.DEFAULTS, o.data(), "object" == typeof e && e);
    ...
    i.VERSION = "3.3.1", i.TRANSITION_DURATION = 350, i.DEFAULTS = {
        ...
        this.images.each(function (i) {
            var o = t(this), n = o.is("img") ? o : o.find("img"), s = "undefined" != typeof n.data("width") ? n.data("width") : n.width(), a = "undefined" != typeof n.data("height") ? n.data("height") : n.height();
            n.data("width", s), n.data("height", a);
            var r = Math.ceil(s / a * e.options.targetHeight), l = Math.ceil(e.options.targetHeight);
        ...
        for (var i = this.options.padding * (this.elements.length - 1), o = this.albumWidth - i, n = o / (e - i), s = i, a = (e < this.albumWidth, 0); a < this.elements.length; a++) {
            var r = t(this.elements[a][0]), l = Math.floor(this.elements[a][1] * n), h = Math.floor(this.elements[a][2] * n), d = a < this.elements.length - 1;
    ...
    t.fn.lazyload = function (s) {
        ...
        var a;
        return a = s.container === o || s.container === e ? (e.innerHeight ? e.innerHeight : n.height()) + n.scrollTop() : t(s.container).offset().top + t(s.container).height(), a <= t(i).offset().top - s.threshold
    ...
    "use strict";
    t.fn.pin = function (e) {
        var i = 0, o = [], n = !1, s = t(window);
        e = e || {};
        var a = function () {
            for (var i = 0, a = o.length; a > i; i++) {
                var r = o[i];
                if (e.minWidth && s.width() <= e.minWidth)r.parent().is(".pin-wrapper") && r.unwrap(), r.css({
                    width: "",
                    left: "",
                    top: "",
                    position: ""
                }), e.activeClass && r.removeClass(e.activeClass), n = !0; else {
                    n = !1;
                    ...
                    r.data("pin", {
                        ...
                        parentTop: c.top
                    }), r.css({width: r.outerWidth()}), r.parent().css("height", r.outerHeight())
                }
            }
        }, r = function () {
            if (!n) {
    ...
    e.prototype.listen = function () {
        ...
        var e = this._fullWidth, o = this._fullHeight, n = (t(window).scrollTop(), e / this._targetImage.width), s = t(window).height() - i.OFFSET, a = t(window).width() - i.OFFSET, r = e / o, l = a / s;
        ...
        this._targetImage.offsetWidth;
        var e = t(this._targetImage).offset(), i = t(window).scrollTop(), o = i + t(window).height() / 2, n = t(window).width() / 2, s = e.top + this._targetImage.height / 2, a = e.left + this._targetImage.width / 2;
